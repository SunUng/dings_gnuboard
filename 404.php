...
include_once($serverRoot.'/common.php');
 ?>
<!DOCTYPE html>
<html lang="ko">
<head>
  ...
  <style>
    ...
    .ment-top{font-size:120px;font-weight:900;color:#fff}
    .ment-bot{font-size:16px;color:#fff;margin:1% 0;font-weight:100}
    ...
    100%{-webkit-transform:rotate(-360deg);transform:rotate(-360deg);transition:transform 20s}
    }
    ...
    @keyframes glow-star {
    40%{-webkit-opacity:.3;opacity:.3}
    90%,100%{-webkit-opacity:1;opacity:1;-webkit-transform:scale(1.2);transform:scale(1.2);border-radius:999999px}
    }
    .spin-earth-on-hover{transition:ease 200s!important;transform:rotate(-3600deg)!important}
    html,body{margin:0;width:100%;height:100%;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}
    .bg-purple{background:url('<?php echo G5_URL ?>/404/bg_purple.png');background-repeat:repeat-x;background-size:cover;background-position:left top;height:100%;overflow:hidden}
    ...
    li{float:left;padding:0 15px}
    li a{display:block;color:#fff;text-align:center;text-decoration:none;letter-spacing:2px;font-size:12px;-webkit-transition:all .2s ease-in;-moz-transition:all .2s ease-in;-ms-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in}
    li a:hover{color:#ffcb39}
    .btn-request{padding:10px 25px;border:1px solid #FFCB39;border-radius:100px;font-weight:400}
    .btn-request:hover{background-color:#FFCB39;color:#fff;transform:scale(1.05);box-shadow:0 20px 20px rgba(0,0,0,0.1)}
    .btn-go-home{position:relative;z-index:200;margin:15px auto;white-space:nowrap;display:inline-block;padding:10px 15px;border:1px solid #FFCB39;border-radius:100px;font-weight:500;color:#fff;text-align:center;text-decoration:none;font-size:18px;-webkit-transition:all .2s ease-in;-moz-transition:all .2s ease-in;-ms-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in}
    .btn-go-home:hover{background-color:#FFCB39;color:#fff;box-shadow:0 20px 20px rgba(0,0,0,0.1)}
    .central-body{padding:17% 5% 10%;text-align:center}
    ...
    .stars{background:url('<?php echo G5_URL ?>/404/overlay_stars.svg');background-repeat:repeat;background-size:contain;background-position:left top}
    .glowing_stars .star{position:absolute;border-radius:100%;background-color:#fff;width:3px;height:3px;opacity:.3;will-change:opacity}
