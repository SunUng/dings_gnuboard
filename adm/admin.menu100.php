<?php
$menu['menu100'] = array (
    array('100000', '환경설정', G5_ADMIN_URL.'/config_form.php',   'config', 0),
    array('100100', '기본환경설정', G5_ADMIN_URL.'/config_form.php',   'cf_basic', 0),
    array('100200', '관리권한설정', G5_ADMIN_URL.'/auth_list.php',     'cf_auth', 0),
    array('100280', '테마설정', G5_ADMIN_URL.'/theme.php',     'cf_theme', 1),
    array('100290', '메뉴설정', G5_ADMIN_URL.'/menu_list.php',     'cf_menu', 1),
    array('100300', '메일 테스트', G5_ADMIN_URL.'/sendmail_test.php', 'cf_mailtest', 0),
    array('100310', '팝업레이어관리', G5_ADMIN_URL.'/newwinlist.php', 'scf_poplayer', 0),
    ...
    array('100500', 'phpinfo()',        G5_ADMIN_URL.'/phpinfo.php',       'cf_phpinfo', 0)
);
